...
void main(uint3 dispatchThreadID : SV_DispatchThreadID)
{
    ...
    for (int i = 0; i <= 6; i++) // У тебя было 5, оставляю так же
    {
        ...
        switch (slotID) {
            ...
            case 5: decalCenter=float2(0.644324,0.155186);decalSize=float2(0.141224,0.141224);decalAngle=0.0;tileGrid=float2(4,2);mirror=true;flip=true;atlasIndex=62;break; // Пример: 180 градусов
