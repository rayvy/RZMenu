...
class RZM_OT_validate_curve_vfx(Operator):
    ...
    def execute(self, context):
        ...
        for idx, curve_obj in enumerate(vfx_curves):
            ...
            particle_size_start = get_curve_prop(curve_obj, "particle_size_start", 0.05)
            particle_size_end = get_curve_prop(curve_obj, "particle_size_end", 0.01)
            ...
            print(f"[RZM-VFX]   * Particle Size Start/End: {particle_size_start} -> {particle_size_end}")
